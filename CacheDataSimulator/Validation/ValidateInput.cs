...
namespace CacheDataSimulator.Validation
{
    class ValidateInput
    {
        ...
        {
            string err = string.Empty;
            err += "SUCCESS: The code has been built successfully with no errors." + "\r\n";
            return err;
        }
        ...
        {
            string err = string.Empty;
            err += "SUCCESS: Code Execution has been completed." + "\r\n";
            return err;
        }
        ...
        {
            string err = string.Empty;
            err += "ASSEMBLE: Source code is being assembled!" + "\r\n";
            return err;
        }
